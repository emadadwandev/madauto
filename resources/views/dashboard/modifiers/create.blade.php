        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('dashboard.modifiers.store', ['subdomain' => request()->route('subdomain')]) }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="number"
                                       ...
                                       id="price_adjustment"
                                       value="{{ old('price_adjustment', '0.00') }}"
                                       step="0.01"
                                       required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('loyverse_modifier_id') }}"
                            ...
                            <p class="mt-1 text-sm text-gray-500">Leave blank to auto-create in Loyverse or use "Sync from Loyverse" to import existing modifiers</p>
