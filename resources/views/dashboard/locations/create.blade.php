    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('dashboard.locations.store', ['subdomain' => request()->route('subdomain')]) }}" class="p-6">
                    @csrf
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" required
                                   ...
                                   value="{{ old('name') }}" placeholder="e.g., Downtown Branch">
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                                   value="{{ old('email') }}" placeholder="location@restaurant.com">
                            @error('email')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="tel" name="phone" id="phone"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                                   value="{{ old('phone') }}" placeholder="+971 4 123 4567">
                            @error('phone')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="address_line2" id="address_line2"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                                   value="{{ old('address_line2') }}" placeholder="Suite 100">
                            @error('address_line2')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="city" id="city" required
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                                       value="{{ old('city') }}" placeholder="Dubai">
                                @error('city')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="state" id="state"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                                       value="{{ old('state') }}" placeholder="Dubai">
                                @error('state')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="country" id="country" required
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                                       value="{{ old('country') }}" placeholder="United Arab Emirates">
                                @error('country')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            @foreach(['careem', 'talabat'] as $platform)
                                <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50">
                                    <input type="checkbox" name="platforms[]" value="{{ $platform }}"
                                           @checked(in_array($platform, old('platforms', [])))
                    ...
                    <div class="mb-8">
                        ...
                        <input type="text" name="loyverse_store_id" id="loyverse_store_id"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                               value="{{ old('loyverse_store_id') }}" placeholder="Store ID from Loyverse POS">
