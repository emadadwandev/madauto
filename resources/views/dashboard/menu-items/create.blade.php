    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('dashboard.menus.items.store', ['menu' => $menu, 'subdomain' => request()->route('subdomain')]) }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div>
                                    ...
                                    <select name="loyverse_item_id"
                                        ...
                                        @foreach($loyverseItems as $loyverseItem)
                                            <option value="{{ $loyverseItem['id'] }}" {{ old('loyverse_item_id') == $loyverseItem['id'] ? 'selected' : '' }}>
