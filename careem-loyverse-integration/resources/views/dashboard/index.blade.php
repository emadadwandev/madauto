                    ...
                    <div class="p-6">
                        ...
                        <div class="text-xs text-gray-500 mt-1">
                            @if($stats['failed_orders'] > 0)
                                <a href="{{ route('sync-logs.index') }}?status=failed" class="text-blue-600 hover:text-blue-800">View logs</a>
                            @else
                                No failures
                            @endif
                        </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                <a href="{{ route('product-mappings.index') }}" class="text-blue-600 hover:text-blue-800 text-sm">Manage</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('orders.index') }}" class="text-blue-600 hover:text-blue-800 text-sm">View All</a>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('sync-logs.index') }}" class="text-blue-600 hover:text-blue-800 text-sm">View All Logs</a>
                    </div>
