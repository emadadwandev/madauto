    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('product-mappings.store') }}">
                        @csrf
                            ...
                            >
                                ...
                                @foreach ($loyverseItems as $item)
                                    <option
                                        ...
                                        {{ old('loyverse_item_id') === $item['item_id'] ? 'selected' : '' }}
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('product-mappings.index') }}" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                                Cancel
                            </a>
                        </div>
                    </form>
